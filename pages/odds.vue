<template>
  <div class="wrapper">
    ...
    <div class="flex box-border max-w-full">
            ...
            <tr class="border text-center">
              ...
              <td class="px-2 flex flex-col">
                <div class="flex my-2 ml-3">
                  <img
                    class="w-6 h-6 mr-2"
                    :src="'/' + sportImgUrl + '/' + item.away_team + ImgUrl"
                    alt=""
                  />
                  <span
                    class="hover:bg-orange-400 hover:text-white hover:duration-200"
                  >
                    {{ item.away_team }}
                  </span>
                </div>
                <div class="flex my-2 ml-3">
                  <img
                    class="w-6 h-6 mr-2"
                    :src="'/' + sportImgUrl + '/' + item.home_team + ImgUrl"
                    alt=""
                  />
                  <span
                    class="hover:bg-orange-400 hover:text-white hover:duration-200"
              ...
              <td class="hidden lg:table-cell text-sm text-gray-600">
                <div class="flex flex-col items-center">
                  ...
                  >
                    {{
                      item.bookmakers[3]["markets"][2]
                        ? item.bookmakers[3]["markets"][2]["outcomes"][0][
                            "point"
                          ]
                        : ""
                    }}
                  </div>
                  <div v-else-if="sportSelectValue === 'baseball_mlb'">
                    {{
                      item.bookmakers[3]["markets"][0]["outcomes"][0][
                        "price"
                      ].toFixed(2)
                    }}
                  </div>
                  <div v-if="sportSelectValue === 'basketball_nba'">
                    {{
                  ...
                  <div v-else-if="sportSelectValue === 'baseball_mlb'">
                    {{
                      item.bookmakers[3]["markets"][0]["outcomes"][1][
                        "price"
                      ].toFixed(2)
                    }}
                  </div>
        ...
        <thead class="h-10 bg-stone-200 border-b">
          <tr>
            ...
            <th>
              ...
              >
                <img class="w-28 h-8" src="/fanduel.jpg" alt="" />
              </a>
            </th>
            <th>
              <a
        ...
        <tbody class="border-b">
          <template v-for="item in oddsDataList" :key="item.id">
            <tr class="border text-sm">
              <template v-for="list in item.bookmakers" :key="list.key">
                <td v-if="list.title === 'FOX Bet'">
                  <div class="flex justify-center">
                    <span class="mr-2">
                      {{
                        list.markets[2]
                          ? list.markets[2]["outcomes"][0]["point"]
                          : ""
                      }}
                    </span>
                    ...
                    <span class="text-gray-400">
                      {{
                        list.markets[2]
                          ? betRateConvert(
                              list.markets[2]["outcomes"][0]["price"]
                            )
                          : ""
                      }}
                    </span>
                  ...
                  <div class="flex justify-center">
                    <span class="mr-2">
                      {{
                        list.markets[1]
                          ? list.markets[1]["outcomes"][1]["point"]
                          : ""
                      }}
                    </span>
                    <span class="text-gray-400">
                      {{
                        list.markets[1]
                          ? betRateConvert(
                              list.markets[1]["outcomes"][1]["price"]
                            )
                          : ""
                      }}
                    </span>
                ...
                <td v-else-if="list.title === 'William Hill (US)'">
                  <div class="flex justify-center">
                    <span class="mr-2">
                      {{
                        list.markets[2]
                ...
                <td v-else-if="list.title === 'BetUS'">
                  <div class="flex justify-center">
                    <span class="mr-2">
                      {{
                        list.markets[2] && list.markets[2]["key"] == "totals"
                          ? list.markets[2]["outcomes"][0]["point"]
                          : ""
                      }}
                    </span>
      ...
      <table class="oddsTable" v-else-if="sportSelectValue === 'baseball_mlb'">
        <thead class="h-10 bg-stone-200 border-b">
          <tr>
            <th>
              <a
                  ...
                  <div class="flex flex-col justify-center">
                    <span class="mr-2">
                      {{
                        list.markets[0]
                          ? betRateConvert(
                              list.markets[0]["outcomes"][0]["price"]
                            )
                          : ""
                      }}
                    </span>
                    ...
                    <span class="">
                      {{
                        list.markets[0]
                          ? betRateConvert(
                              list.markets[0]["outcomes"][1]["price"]
                            )
                          : ""
                      }}
                    </span>
